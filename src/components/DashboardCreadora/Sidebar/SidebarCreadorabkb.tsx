import { BarChart3, Image, Package, Radio, MessageCircle, Mail, DollarSign, Settings, TrendingUp, X, LogOut, Home, Crown } from 'lucide-react';
...
export const SidebarCreadorabkb = ({ isOpen, onClose, activeTab, onTabChange }: SidebarCreadoraProps) => {
