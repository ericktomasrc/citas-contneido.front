...
// ✅ Chat estilo WhatsApp - Simple, premium, elegante
      ...
      {role === 'creadora' && (
        <div className="flex-shrink-0 bg-white border-b border-slate-200 px-6 py-3">
          <div className="flex items-center gap-3">
            <button onClick={() => setShowGiftsReport(true)}
              ...
              <Gift className="w-4 h-4" /> Mis Regalos
            </button>
            <button onClick={() => setShowTipsReport(true)}
              ...
              <DollarSign className="w-4 h-4" /> Mis Propinas
            </button>
          </div>
        </div>
      )}
